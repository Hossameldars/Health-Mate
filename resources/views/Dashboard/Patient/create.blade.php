          ...
          @csrf
				<div class="row">
					...
					<div class="col-lg-12 col-md-12">
									...
									<div class="col-md-10 col-lg-8 col-xl-6 mx-auto d-block">
										<div class="card card-body pd-20 pd-md-40 border shadow-none">
											...
											<div class="form-group">
												...
												<label class="main-content-label tx-11 tx-medium tx-gray-600">fullName</label> <input class="form-control" required="" name="fullName" type="text">
											</div>
                      <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">email</label> <input class="form-control" required="" name="email" type="email">
											</div>
                      <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">DateofBirth</label> <input class="form-control" required="" name="DateofBirth" type="date">
											</div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">address</label> <input class="form-control" required="" name="address" type="text">
											</div>
                      <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">Phone Number</label> <input class="form-control" required="" name="phoneNumber" type="text">
											</div>
											{{-- <div class="form-group">
