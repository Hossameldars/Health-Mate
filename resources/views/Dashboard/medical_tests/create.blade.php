...
@section('content')
				...
				<!-- row -->
        <form action="{{ route('medical_test.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
				<div class="row">
									...
									<div class="col-md-10 col-lg-8 col-xl-6 mx-auto d-block">
										<div class="card card-body pd-20 pd-md-40 border shadow-none">
											...
											<div class="form-group">
												...
												<label class="main-content-label tx-11 tx-medium tx-gray-600">test_name</label> <input class="form-control" required="" name="test_name" type="text">
											</div>
                      <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">schedule</label> <input class="form-control" required="" name="schedule" type="text">
											</div>
                       <div class="form-group">
    ...
    @enderror
                      ...
                      <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">cost</label> <input class="form-control" required="" name="cost" type="text">
											</div>
											{{-- <div class="form-group">
