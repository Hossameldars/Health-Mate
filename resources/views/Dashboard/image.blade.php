                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="#" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="title" class="col-md-4 col-form-label text-md-right">{{ __('Image Title') }}</label>

                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="doctor_id" value="{{ old('title') }}" required autocomplete="title" autofocus>
