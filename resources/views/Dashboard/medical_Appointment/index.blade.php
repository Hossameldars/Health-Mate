...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto"style="color: #5D9CEC;">Medical Test Appointments</h4>
						</div>
					</div>
                  ...
                  <div class="d-flex justify-content-between">
                    <div  class="row justify-content-center mt-4">
                      {{-- <div class="col-md-10 d-flex justify-content-end">
                          ...
                          <a href="{{ route('medical_appointment.create') }}" class="btns btn-add">
              ...
              ` 
                    ...
                    <table class="table text-md-nowrap" id="example1">
                      <thead>
                        <tr>
                          ...
                          <th class="wd-15p border-bottom-0">test</th>
                          <th class="wd-20p border-bottom-0">doctor</th>
                ...
                <tr>
                  ...
                  {{-- <th>  {{ $appointment->id }}</th> --}}
                    ...
                    <td>{{ $test->MedicalTest->test_name }}</td>
                    <td>{{ $test->Doctor->fristName }} {{ $test->Doctor->lastName }}</td>
