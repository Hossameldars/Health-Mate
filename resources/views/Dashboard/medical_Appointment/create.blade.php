...
@section('content')
				...
				<!-- row -->
        <form action="{{ route('medical_appointment.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
				<div class="row">
					...
					<div class="col-lg-12 col-md-12">
                      ...
                      <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">appointment_date</label> <input class="form-control" required="" name="appoint_date" type="date">
											</div>
                        <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">appointment_date</label> <input class="form-control" required="" name="appoint_time" type="time">
											</div>
