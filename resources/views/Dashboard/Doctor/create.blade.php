									...
									<div class="col-md-10 col-lg-8 col-xl-6 mx-auto d-block">
										<div class="card card-body pd-20 pd-md-40 border shadow-none">
											...
											<div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">firstName</label> <input class="form-control"  name="firstName" type="text">
											</div>
                      <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">lastName</label> <input class="form-control"  name="lastName" type="text">
											</div>
                      <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">username</label> <input class="form-control" name="username" type="text">
											</div>
                      <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">email</label> <input class="form-control"  name="email" type="email">
											</div>
                      <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">password</label> <input class="form-control"  name="password" type="password">
											</div>
                      <div class="form-group">
												<label class="main-content-label tx-11 tx-medium tx-gray-600">Phone Number</label> <input class="form-control"  name="phoneNumber" type="text">
											</div>
											{{-- <div class="form-group">
                      ...
                      <div class="form-group">
												<div class="row row-sm">
													<div class="col-sm-9">
														...
														<div class="row row-sm">
															<div class="col-sm-7">
																<select class="form-control select2-no-search" name="rating">
                                  <option label="Choose one">
																	</option>
                                  <option value="1">
                                  1
