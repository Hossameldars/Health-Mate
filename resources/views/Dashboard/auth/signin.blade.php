...
<!-- Create Post Form -->
									<div class="card-sigin">
										<div class="mb-5 d-flex"> <a href="{{ url('/' . $page='index') }}"><img src="" class="sign-favicon ht-40" alt=""></a><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28"><span></span></h1></div>
										<div class="card-sigin">
        	...
        	<div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
					<div class="row wd-100p mx-auto text-center">
						<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
							<img src="{{URL::asset('Dashboard/img/faces/update_health_mate.png')}}" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
						</div>
					</div>
				</div><!-- End -->
			</div>
