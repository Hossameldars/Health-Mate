...
@section('content')
        ...
        <div class="form-group">
            ...
            <select name="appointment_id" id="appointment_id" class="form-control" required>
                ...
                @endforeach
                       ...
                       <div class="form-group">
            <label for="pat_id">Patient (Optional)</label>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <input type="file" name="result_file" id="result_file" class="form-control-file" required accept=".pdf">
        </div>
                       <div class="form-group">
                      <label class="main-content-label tx-11 tx-medium tx-gray-600">notes</label> 
                          <textarea class="form-control" aria-label="With textarea" name="notes"  >{{ old('notes') }}</textarea>
                            @error('notes')
